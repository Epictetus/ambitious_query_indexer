...
This plugin works on the principle that while it's possible to make a good guess at how a table should be indexed based upon its columns and contents, by looking at the actual queries your app is running, it will be possible to get much better indexes in place.

h2. Installation

@script/plugin install git://github.com/samdanavia/ambitious_model_loader.git@
...
Copyright (c) 2009 Sam Phillips, released under the MIT license
